...
<div class="navbar coreos-subnav" role="navigation">
  <div class="container">
    <div class="navbar-header">
      <button class="navbar-toggle" type="button" data-toggle="collapse" data-target=".coreos-subnav-collapse">
        <span class="icon-bar"></span>
        <span class="icon-bar"></span>
        <span class="icon-bar"></span>
      </button>
      <div class="nav-hint pull-right visible-xs">CoreOS Technologies</div>
    </div>
    <div class="navbar-collapse collapse coreos-subnav-collapse">
      <ul class="nav navbar-nav">
        <li>
        <a href="/using-coreos/clustering/" data-category="Using CoreOS Subnav" data-event="Using CoreOS: fleet">集群管理</a>
        </li>
        <li>
        <a href="/using-coreos/etcd/" data-category="Using CoreOS Subnav" data-event="Using CoreOS: etcd">etcd</a>
        </li>
        <li>
        <a href="/using-coreos/docker/" data-category="Using CoreOS Subnav" data-event="Using CoreOS: docker">docker</a>
        </li>
        <li>
        <a href="/using-coreos/systemd/" data-category="Using CoreOS Subnav" data-event="Using CoreOS: systemd">systemd</a>
        </li>
        <li>
        <a href="/using-coreos/updates/" data-category="Using CoreOS Subnav" data-event="Using CoreOS: Updates">升级 & 补丁</a>
        </li>
      </ul>
    </div>
  </div>
